...
export const ko: Translations = {
  ...
  status: {
    ...
    stopped: "중지됨",
    updateHermes: "Bithumb Agent 업데이트",
    updatingHermes: "Bithumb Agent 업데이트 중…",
  ...
  oauth: {
    title: "Bithumb Agent OAuth 계정",
    providerLogins: "Bithumb Agent OAuth 계정",
    description:
      "{connected}/{total} 연결됨. Bithumb Agent는 ChatGPT와 Gemini 구독 OAuth만 지원하며, 추론 API 키와 Gemini 유료 초과 사용은 차단됩니다.",
    connected: "연결됨",
    expired: "만료됨",
