...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateHermes: "Update Bithumb Agent",
    ...
    updatingHermes: "Updating Bithumb Agent…",
  ...
  oauth: {
    title: "Bithumb Agent OAuth Accounts",
    providerLogins: "Bithumb Agent OAuth Accounts",
    description:
      "{connected} of {total} connected. Bithumb Agent supports ChatGPT and Gemini subscription OAuth only; inference API keys and paid Gemini overages are disabled.",
    connected: "Connected",
    expired: "Expired",
