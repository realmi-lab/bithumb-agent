...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Bithumb Agent Teal",
  description: "Bithumb Agent dark teal",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Bithumb Agent Teal (Large)",
  description: "Bithumb Agent Teal with bigger fonts and roomier spacing",
