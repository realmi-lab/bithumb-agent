...
import { BITHUMB_AGENT_INFERENCE_API_KEYS_ENABLED } from "@/lib/bithumb-agent-policy";
...
export default function SystemPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
        ...
        <Card>
          <CardContent className="py-4">
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-y-3 gap-x-6 text-sm">
              ...
              <div>
                <div className="text-xs uppercase tracking-wider text-muted-foreground">Bithumb Agent</div>
                <div className="flex items-center gap-2">
      ...
      {/* ── Credential pool ───────────────────────────────────────── */}
      {BITHUMB_AGENT_INFERENCE_API_KEYS_ENABLED && <section className="flex flex-col gap-3">
        <H2 variant="sm" className="flex items-center gap-2 text-muted-foreground">
