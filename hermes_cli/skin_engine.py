"""Bithumb Agent CLI skin/theme engine, compatible with Hermes skins.
...
- ``default`` — Bithumb Agent orange open-source branding
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Bithumb Agent — orange open-source customization",
        "colors": {
            "banner_border": "#CF4F08",
            "banner_title": "#FF8A3D",
            "banner_accent": "#F37021",
            "banner_dim": "#A54100",
            "banner_text": "#FFF3EB",
            "ui_accent": "#F37021",
            "ui_label": "#FF8A3D",
            ...
            "prompt": "#FFF3EB",
            "input_rule": "#CF4F08",
            "response_border": "#F37021",
            "status_bar_bg": "#1a1a2e",
            "session_label": "#FF8A3D",
        ...
        "branding": {
            "agent_name": "Bithumb Agent",
            "welcome": "Welcome to Bithumb Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye from Bithumb Agent!",
            "response_label": " B Bithumb Agent ",
            "prompt_symbol": "❯",
            "help_header": "BITHUMB AGENT · Available Commands",
        },
        "tool_prefix": "┊",
    },
    "ares": {
