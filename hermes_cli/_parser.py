...
Examples:
    ...
    bithumb-agent chat -q "Hello"        Single query mode
    bithumb-agent --tui                  Launch the modern TUI
    bithumb-agent --cli                  Force the classic REPL
    bithumb-agent -c                     Resume the most recent session
    bithumb-agent setup                  Run setup wizard
    bithumb-agent model                  Select default model
    bithumb-agent config                 View configuration
    bithumb-agent gateway                Run messaging gateway
    bithumb-agent sessions browse        Interactive session picker
    bithumb-agent logs -f                Follow agent.log in real time
    bithumb-agent update                 Update the Hermes-derived runtime

For more help on a command:
    bithumb-agent <command> --help
"""
...
def build_top_level_parser():
    ...
    parser = argparse.ArgumentParser(
        prog="bithumb-agent",
        description=(
            "Bithumb Agent - open-source AI assistant customized from "
            "Hermes Agent (MIT), with an Antigravity-inspired CLI experience"
        ),
    ...
    _inherited_flag(
        ...
        default=None,
        help=(
            "OAuth provider override: openai-codex or antigravity-cli. "
    ...
    chat_parser = subparsers.add_parser(
        ...
        description="Start an interactive Bithumb Agent chat session",
    )
    ...
    _inherited_flag(
        ...
        "--provider",
        default=argparse.SUPPRESS,
        help="OAuth provider: openai-codex or antigravity-cli (default: auto).",
    )
    chat_parser.add_argument(
        "-v",
        "--verbose",
